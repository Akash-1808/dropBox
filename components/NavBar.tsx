    ...
    >
      <div className="container mx-auto py-3 md:py-4 px-4 md:px-6">
        <div className="flex justify-between items-center">
            ...
            <SignedIn>
              <div className="flex items-center gap-4">
                ...
                <Dropdown>
                  ...
                  <DropdownMenu aria-label="User actions" className="bg-white shadow-lg rounded-md p-2 gap-2">
                    <DropdownItem
                      key="profile"
                      description={userDetails.email || "View your profile"}
                      onClick={() => router.push("/dashboard?tab=profile")}
                      className="bg-white hover:bg-blue-50 border-1 border-blue-200 m-1 p-2 rounded-md"
                    >
                      Profile
                    </DropdownItem>
                    <DropdownItem
                    ...
                    <DropdownItem
                      ...
                      className="text-danger bg-white hover:bg-blue-50 border-1 m-1 border-blue-200 p-2 rounded-md"
                    >
                      Sign Out
                    </DropdownItem>
                  </DropdownMenu>
          ...
          <div
            ref={mobileMenuRef}
            className={`fixed top-0 right-0 bottom-0 w-4/5 max-w-sm bg-blue-50 z-40 flex flex-col pt-20 px-6 shadow-xl transition-transform duration-300 ease-in-out ${
          ...
          >
            ...
            <SignedIn>
              <div className="flex flex-col gap-6">
                {/* User info */}
                <div className="flex items-center gap-3 py-4 border-b border-blue-200">
                  <Avatar
                    name={userDetails.initials}
                    size="md"
                    src={user?.imageUrl || undefined}
                ...
                <div className="flex flex-col gap-4">
                  {!isOnDashboard && (
                    <Link
                      href="/dashboard"
                      className="py-2 px-3 hover:bg-blue-100 rounded-md transition-colors"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Dashboard
                    </Link>
