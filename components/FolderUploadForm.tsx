  ...
  return (
    <div className="space-y-4">
        ...
        className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${
          error
            ...
            : file
              ...
              : "border-blue-300 hover:border-primary/5"
        }`}
      >
        {!file ? (
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-500 mt-1">Images up to 5MB</p>
            </div>
            <Input
              type="file"
              ref={fileInputRef}
          ...
          <div className="space-y-3">
            ...
            {error && (
              <div className="bg-danger-50 text-danger-700 p-3 rounded-lg flex items-center gap-2">
      ...
      <Modal
        ...
        backdrop="blur"
        classNames={{
          base: "border border-blue-200 bg-blue-50 rounded-sm backdrop-blur-sm",
          header: "border-b border-blue-200 bg",
          footer: "border-t border-blue-200",
        }}
      >
        <ModalContent>
